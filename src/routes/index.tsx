...
// employee
const Employee = React.lazy(() => import("../pages/employee/department"));
const Designation = React.lazy(() => import("../pages/employee/designation"));
const Timesheet = React.lazy(() => import("../pages/employee/timesheet"));
const ShiftSchedule = React.lazy(() =>
  import("../pages/employee/shiftSchedule")
);
const Overtime = React.lazy(() => import("../pages/employee/overtime"));
const ShiftList = React.lazy(() => import("../pages/employee/shiftList"));
